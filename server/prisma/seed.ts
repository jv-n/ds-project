  ...
  await prisma.apoio.createMany({
    data: [
      // Apoio 1: Empresa 1 para Acao 1 - PENDENTE (primeira doação)
      {
        ...
        valor: 150.00,
        tipoAjuda: 'Dinheiro',
        documentacao: 'doc_inverno_solidario_emp1_1.pdf',
      ...
      // Apoio 2: Empresa 1 para Acao 1 - APROVADO (segunda doação)
      {
        ...
        valor: 200.00,
        tipoAjuda: 'Roupas',
        documentacao: 'doc_inverno_solidario_emp1_2.pdf',
        empresaId: empresa1.id,
        ongId: ong1.id,
        acaoId: acao1.id,
      ...
      // Apoio 3: Empresa 1 para Acao 1 - APROVADO (terceira doação)
      {
        ...
        valor: 50.00,
        tipoAjuda: 'Alimento',
        documentacao: 'doc_inverno_solidario_emp1_3.pdf',
        empresaId: empresa1.id,
        ongId: ong1.id,
        acaoId: acao1.id,
        status: StatusApoio.APROVADO,
      ...
      // Apoio 4: Empresa 2 para Acao 2 - CONTATO_INICIAL (apenas iniciou contato)
      {
        ...
        tipoAjuda: 'Contato',
        documentacao: 'sem-documento.pdf',
      ...
      // Apoio 5: Empresa 1 para Acao 3 - REJEITADO
      {
        ...
        valor: 100.00,
        tipoAjuda: 'Serviço',
        documentacao: 'doc_alimento_todos_emp1_1.pdf',
        empresaId: empresa1.id,
        ongId: ong1.id,
        acaoId: acao3.id,
      ...
      // Apoio 6: Empresa 2 para Acao 3 - PENDENTE
      {
        ...
        valor: 75.00,
        tipoAjuda: 'Dinheiro',
        documentacao: 'doc_alimento_todos_emp2_1.pdf',
        empresaId: empresa2.id,
        ongId: ong1.id,
        acaoId: acao3.id,
        status: StatusApoio.PENDENTE,
      ...
      // Apoio 7: Empresa 1 para Acao 2 - APROVADO
      {
        ...
        valor: 300.00,
        tipoAjuda: 'Dinheiro',
        documentacao: 'doc_verde_esperanca_emp1_1.pdf',
        empresaId: empresa1.id,
        ongId: ong2.id,
        acaoId: acao2.id,
        status: StatusApoio.APROVADO,
      ...
      // Apoio 8: Empresa 2 para Acao 4 - APROVADO
      {
        ...
        valor: 340.00, 
        tipoAjuda: 'Dinheiro',
        documentacao: 'comprovante_pix.pdf',
        empresaId: empresa2.id,
        ongId: ong2.id,
        acaoId: acao4.id,
        status: StatusApoio.APROVADO,
