...
-- DropForeignKey
ALTER TABLE "File" DROP CONSTRAINT "File_apoioId_fkey";

-- DropForeignKey
ALTER TABLE "Prefeitura" DROP CONSTRAINT "Prefeitura_usuarioId_fkey";

-- AlterTable
ALTER TABLE "Empresa" DROP COLUMN "pontos",
...
-- AlterTable
ALTER TABLE "Selo" DROP COLUMN "tier",
DROP COLUMN "tipo",
ADD COLUMN     "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
-- AlterTable
ALTER TABLE "Usuario" ADD COLUMN     "perfil" TEXT NOT NULL DEFAULT 'empresa';
