              ...
              <div className="w-[950px] bg-[#FFFFFF] h-[55px] border-[1px] border-gray-300 rounded-xl flex flex-col justify-center mb-3">
                <div className="ml-[10px]">
                  <div className="flex items-center">
                    ...
                    <div className="w-[53px] h-[20px] border-[2px] border-gray-400 bg-white rounded-md flex justify-center items-center ml-auto text-black font-bold text-[14px] mr-[10px]">
